...
from fishapiv4.database.models import FeedHistory, Pond, PondActivation, FishDeath, FishTransfer, FishGrading, OptionTable, DailyWaterQuality, WeeklyWaterQuality, PondTreatment, Logging
...
def create_app(test_config=None):
    ...
    #app.config['MONGODB_SETTINGS'] = [{'db':'fishapiv4', 'alias':'default'},{"db": "fishapiv4","alias": "new_connection"}]
